...
const AboutSection = () => {
  ...
  const testimonials = [
  {
    text: "If you're looking for top-quality window tinting or full vehicle wrapping, Max Wrapping is the place to go! Professional service, great attention to detail, and a real passion for making cars look their best. Whether you're after a subtle upgrade or a full transformation, you can count on expert advice and excellent results. Highly recommended for anyone who wants their car to stand out!",
    name: "Piotr Pajecki",
  },
